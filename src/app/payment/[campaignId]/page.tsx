...
export default function PaymentPage() {
  ...
  // setSearchParams handled via router.replace
  const setSearchParams = (_: Record<string, string>, opts?: { replace?: boolean }) => {
    if (opts?.replace) router.replace(window.location.pathname);
  };
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <div className="col-span-2 space-y-6">
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className={`flex items-center justify-center gap-2 rounded-lg border-2 px-4 py-3 font-medium transition-all ${donationType === "one-time"
                    ...
                    <button
                      ...
                      className={`flex items-center justify-center gap-2 rounded-lg border-2 px-4 py-3 font-medium transition-all ${donationType === "recurring"
                    ...
                    <div className="grid grid-cols-4 gap-3">
                      {recurringIntervals.map((interval) => (
                        <button
                          ...
                          className={`rounded-lg border-2 px-4 py-3 font-medium transition-all ${selectedInterval === interval.id
                            ? "border-purple-500 bg-purple-50 text-purple-700"
                            : "border-gray-200 bg-white text-gray-700 hover:border-gray-300"
                            }`}
                        >
                  ...
                  <div className="grid grid-cols-4 gap-3">
                    {suggestedAmounts.map((amount) => (
                      <button
                        ...
                        className={`rounded-lg border-2 px-4 py-3 font-medium transition-all ${selectedAmount === amount
                          ? "border-teal-500 bg-teal-50 text-teal-700"
                          : "border-gray-200 bg-white text-gray-700 hover:border-gray-300"
                          }`}
                      >
                  ...
                  <div className="space-y-3">
                    {paymentMethods.map((method) => (
                      <button
                        ...
                        className={`flex w-full items-center justify-between rounded-lg border-2 px-4 py-3 transition-all ${selectedPaymentMethod === method.id
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <span className={`font-medium ${selectedPaymentMethod === method.id || method.highlighted
                            ? "text-teal-900"
                            : "text-gray-900"
                            }`}>
                            {method.name}
              ...
              <button
                ...
                className={`w-full rounded-lg px-6 py-4 text-lg font-medium text-white transition-all disabled:cursor-not-allowed disabled:opacity-50 ${donationType === "recurring"
